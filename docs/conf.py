...
import os
import sys
print("Working path via pwd is", os.system('pwd'))
print("Working directory via os.getcwd() is", os.getcwd())
...
latex_documents = [
    (master_doc, 'fmcw.tex', 'fmcw Documentation',
...
man_pages = [
    (master_doc, 'fmcw', 'fmcw Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'fmcw', 'fmcw Documentation',
     author, 'fmcw', 'One line description of project.',
     'Miscellaneous'),
]
